...
const { YOUTUBE_API_KEY, SOUNDCLOUD_CLIENT_ID, LOCALE, DEFAULT_VOLUME } = require("../util/DevbotUtil");
  ...
  async execute(message, args) {
    ...
    if (urlValid) {
      ...
      try {
        ...
        // PATCH 1 : evite casos em que não haja nada nos resultados da pesquisa.
        if (results.length <= 0) {
          // Sem resultados de vídeo.
